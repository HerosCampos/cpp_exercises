...
public:
    ...
    Personal_info(std::string person_name_var = "No name", std::string person_job_title_var = "Unemployed", double person_anual_wage_var = 0.0, int person_id_var = 0, double balance_var = 0);
...
Personal_info::Personal_info(std::string person_name_var, std::string person_job_title_var, double person_anual_wage_var, int person_id_var, double balance_var)
...
Personal_info::Personal_info(const Personal_info &source)
    :Personal_info(source.person_name, source.person_job_title, source.person_anual_wage, source.person_id, source.balance) {
...
bool Personal_info::deposit(double amount)
{
    balance += amount;
...
bool Personal_info::withdraw(double amount)
{
    if((balance - amount) >= 0)
    {
        balance -= amount;
